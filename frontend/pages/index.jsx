      ...
      { assistant_id: trimmedUsername, password },
      {
        ...
        onError: (err) => {
          if (err.response?.data?.error === 'user_not_found') {
            ...
            setMessage("Access unavailable: This account is deactivated. Please contact Mr. Mina El-Raheb (admin) or Tony Joseph (developer).");
      ...
      background: 'linear-gradient(313deg,rgba(94, 38, 181, 1) 0%, rgba(39, 105, 77, 1) 40%, rgba(48, 59, 79, 1) 100%);'
        ...
        <style jsx>{`
          ...
          .login-container::before {
            ...
            right: 0;
            height: 4px;
            background: linear-gradient(313deg,rgba(94, 38, 181, 1) 0%, rgba(39, 105, 77, 1) 40%, #303b4f 100%);
        ...
        <form onSubmit={handleLogin} autoComplete="off">
            ...
            <div className="form-group" style={{ marginBottom: passwordError ? 4 : 24 }}>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', alignItems: 'center', marginTop: 8 }}>
                <a
                  ...
                  onClick={e => { 
                    e.preventDefault(); 
                    setForgotMsg('Contact Mr. Mina El-Raheb (admin) or Tony Joseph (developer)'); 
                  }}
                >
            ...
            {(message || forgotMsg) && (
              <div style={{
                ...
                {forgotMsg ? (
                  <span>
                    Contact Mr. Mina El-Raheb (admin) or Tony Joseph (
                      <a
